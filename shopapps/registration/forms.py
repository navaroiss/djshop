...
class RegistrationForm(forms.Form):
    ...
    username = forms.CharField(max_length=30,
                               ...
                               label=_(u'Username'), help_text = "Username")
    first_name = forms.CharField(max_length=50, widget = forms.TextInput(attrs=attrs_dict),
                                 label=_(u'First name'))
    last_name = forms.CharField(max_length=50, widget = forms.TextInput(attrs=attrs_dict),
                                 label=_(u'Last name'))
